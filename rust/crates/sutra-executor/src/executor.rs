...
pub struct TokenExecutor {
    ...
    /// since the KV covered-set was retired (`datastore-schema-projection.md` §7). `mark_coverage`
...
impl TokenExecutor {
    ...
    /// `datastore-schema-projection.md` §7): one number, one place. Pre-existing KV rows are
    ...
    async fn run_coverage_op(
        ...
        // deployment's OWN declared `coverage` data store (`datastore-schema-projection.md` §7 —
